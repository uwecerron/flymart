...
function runtimeLabel(listing: MarketplaceListing) {
  ...
  if (listing.runtime_kind === "stream") return "VIEW SETUP GUIDE";
  if (listing.runtime_kind === "external") return "VIEW SETUP GUIDE";
